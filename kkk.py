...
V = st.number_input("Voltage (V)", min_value=0.0, value=230.0)
I = st.number_input("Current (I)", min_value=0.0, value=10.0)
PF = st.number_input("Power Factor", min_value=0.0, max_value=1.0, value=0.8)
